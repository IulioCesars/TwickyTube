                            ...
                            <span class='dbd-start-span per-start per-panel-02'>
                                <div class='per-panel-02-into'>
                                        ...
                                        <span class='per-panel-input'>
                                            ...
                                            <input required id='reg-psw-contrasenia-01' name='contrasenia' class='glob-object-input per-psw habilita-deshabilita' type='password' placeholder='ContraseÒa' disabled />
                                        </span>
